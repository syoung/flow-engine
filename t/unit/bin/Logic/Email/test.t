...
PURPOSE
	...
	Test Engine::Logic::Email module
...
BEGIN {
    use_ok('Conf::Yaml');
    use_ok('Engine::Logic::Email');
    use_ok('Test::Engine::Logic::Email');
}
require_ok('Conf::Yaml');
require_ok('Engine::Logic::Email');
require_ok('Test::Engine::Logic::Email');
...
my $object = new Test::Engine::Logic::Email(
    conf        =>  $conf,
    logfile     =>  $logfile,
    dumpfile    =>  $dumpfile,
	log			=>	$log,
...
isa_ok($object, "Test::Engine::Logic::Email", "object");
