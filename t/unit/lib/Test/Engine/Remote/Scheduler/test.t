...
BEGIN {
    use_ok('Test::Engine::Remote::Scheduler'); 
}
require_ok('Test::Engine::Remote::Scheduler');

use Test::Engine::Remote::Scheduler;

#### SET LOGFILE
my $logfile     =   "$Bin/output/test.log";
my $log         =   2;
my $printlog    =   5;
...
my $object = Test::Engine::Remote::Scheduler->new(
    conf               =>        $conf,
    logfile            =>        $logfile,
    log		 =>	$log,
    printlog          =>       $printlog
