...
method usageStats ( $jobs, $label, $duration ) {
...
method statValue ( $stats, $field, $operation ) {
...
#	$self->logDebug("batchstats[0]: ");
	...
	{
		$duration = Util::Timer::runtime( $starttime, time() );
	}
	...
	print OUT "Date:      ";
	print OUT Util::Timer::currentTime(), "\n";
...
method addUsageStatistic ( $label, $duration, $usage ) {
...
=cut
method formatTitle ( $title, $width ) {
